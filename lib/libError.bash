...
# -------------------------------------------------------
#
# @description Set values in an error passing structure.
#
...
# supplied options. Most options are strings so they will need to be in
# double quotes if they have embedded spaces.
#
# @example
...
#
# @arg $1 array is the Error Passing Structure (EPS). If not specified then EPS is `ep1`  <p><p>![](../images/pub/divider-line.png)
#
ksl::epSet()
{
    local eps
